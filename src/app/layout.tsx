...
export const metadata: Metadata = {
  title: "Joule Ventures | Israeli Founders, U.S. Enterprise Solutions",
  description: "High-conviction venture capital backing Israeli founders commercializing enterprise-grade solutions. Day-one partners for U.S. market acceleration.",
  keywords: "venture capital, Israeli startups, enterprise technology, venture funding, startup investment",
  openGraph: {
    title: "Joule Ventures | High-Conviction Venture Capital",
    description: "First-check partners for Israeli founders scaling enterprise solutions in U.S. markets",
    siteName: "Joule Ventures",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766006672713-bb1sdg66.jpg",
        alt: "Joule Ventures - Venture Capital"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Joule Ventures | Venture Capital for Israeli Founders",
    description: "High-conviction investors delivering top asset class returns",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766006672713-bb1sdg66.jpg"]
  },
  robots: {
    index: true,
    follow: true
